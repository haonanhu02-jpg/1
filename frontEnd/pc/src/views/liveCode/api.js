 ...
 * @returns
 */
export const synchUserCodeByConfigIds = (configIds) => post(`${serve}/synchUserCodeByConfigIds`, null, { params: { configIds } })

/**
 * 获取所有员工活码的configId列表
 * @returns
 */
export const getUserCodeConfigIds = () => get(`${serve}/getUserCodeConfigIds`)
